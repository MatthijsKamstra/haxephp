...
Check the [code folder](https://github.com/MatthijsKamstra/haxephp/tree/master/07api/code) for more comments.
...
_The code used in this example can be found [here](https://github.com/MatthijsKamstra/haxephp/tree/master/07api/code)._
...
The class will look simular like this `HomeView` (check the example [code folder](https://github.com/MatthijsKamstra/haxephp/tree/master/07api/code))
